...
---
Last updated 09/25/24 by M.Kachmar
  -updated September for ASHC & FENC
...
CT_survival_plot<-ggsurvplot(fit.surv_CT, data = data_all, break.x.by = 1,
           linetype= c(1, 2),xlab = "Month", ylab= "Survival", xlim = c(5,9), legend.labs= c("Fence Creek", "Ash Creek"),
...
summary(survfit(Surv(Month, Survival) ~ Site, data = data_all), times = 7)
