...
---
Last updated 08/29/24 by M.Kachmar
  -updated August 
...
ASHC_survival_plot<-ggsurvplot(fit.surv_ASHC, data = ASHC, break.x.by = 1,
           linetype= c(1, 2, 3),xlab = NULL, ylab= NULL, xlim = c(5,8), legend.labs= c("bag 1", "bag 2",
                                                                 "bag 3"),
           legend.title = "Replicate:", legend = "top", risk.table =TRUE )+ theme_survminer(base_size = 20,font.legend = c(15))+ggtitle("Ash Creek, CT")
ASHC_survival_plot
...
FENC_survival_plot<-ggsurvplot(fit.surv_FENC, data = FENC,break.x.by = 1,
           linetype= c(1, 2, 3),xlab = NULL, ylab= NULL, xlim = c(5,8), legend.labs= c("bag 1", "bag 2",
                                                                 "bag 3"),
           legend.title = "Replicate:", legend = "top", risk.table =TRUE )+ theme_survminer(base_size = 20,font.legend = c(15))+ggtitle("Fence Creek, CT")
FENC_survival_plot
