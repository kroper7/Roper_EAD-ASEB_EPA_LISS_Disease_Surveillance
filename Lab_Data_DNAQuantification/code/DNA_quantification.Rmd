...
Updated: 09/26/24 K. Lenderman
  - combined new Qubit Files created on 9/26/24
  - added code to calculate mean of duplicate qubit runs
...
```{r}
#Determining mean concetration of duplicate qubit runs
data_means <- aggregate(Concentration~Sample_ID+Date,data=data_all,FUN=mean)
data_means <- data_means %>% rename(Concentration_ng.uL = Concentration, run_date = Date)
