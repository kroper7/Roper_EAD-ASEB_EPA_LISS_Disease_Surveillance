...
Last updated 3/20/24 by M. Kachmar
  - 2024 files upload 
  - Accuracy between double reads 76%
...
data_all_tissue <- list.files(path = "Lab_Data_TissueProcessing/raw_data/Files_by_Month",                           # Identify all CSV files
  pattern = "*.csv", full.names = TRUE) %>% 
  lapply(read_csv) %>%                              # Store all files in list
  bind_rows                                         # Combine data sets into one data set 
data_all_tissue      
