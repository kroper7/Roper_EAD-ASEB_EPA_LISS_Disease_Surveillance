...
ggplot(data=df_intensity_proportions, aes(x=month, y= Proportion, fill=intensity_bin)) +
  ...
  labs(fill ="Dermo Intensity")+
  labs(title="Proportion of Intensity scores of Dermo infection - 2023", x ="Month", y = "Proportion")+ theme(axis.title.y = element_text(size = rel(1.3), angle =90), axis.title.x = element_text(size = rel(1.3), angle = 0))+
