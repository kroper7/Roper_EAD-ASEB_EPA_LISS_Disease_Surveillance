...
Last updated 10/11/2023 by M.Kachmar
RFTM accuracy score = 75.3% (0423 through present)
  -Some of the data files did not have correct date_collected and sites (June & July). Corrected that & data is reading correctly
  -fixed code for comparing R1 & R2 ("R1<R2, FALSE" written twice)
  -Noticed the data_all has a lot of 'NA' outputs into the sheet between data - how to fix this? na.omit() may delete data rows we need
