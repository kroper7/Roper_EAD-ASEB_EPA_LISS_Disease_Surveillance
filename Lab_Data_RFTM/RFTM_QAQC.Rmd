...
```{r}
data_all$results = ifelse(data_all$rftm_reader1 < data_all$rftm_reader1, 'FALSE',
  ifelse(data_all$rftm_reader1 < data_all$rftm_reader1, 'FALSE',
  ifelse(data_all$rftm_reader1 == data_all$rftm_reader1, 'TRUE')))
...
sum(Data_Accuracy$results, na.rm=TRUE)
sum(Data_Accuracy$results, na.rm=FALSE)
