...
Last updated 11/30/2023 by M.Kachmar
...
```{r}
#Set Path
setwd("C:/Users/kelly.roper/Documents/Github/Roper_EAD-ASEB_EPA_LISS_Disease_Surveillance/Lab_Data_RFTM")
```
...
```{r}
data_all <- list.files(path = "C:/Users/kelly.roper/Documents/Github/Roper_EAD-ASEB_EPA_LISS_Disease_Surveillance/Lab_Data_RFTM/Files_by_Month",                           # Identify all CSV files
...
write.csv(data_all, "C:/Users/kelly.roper/Documents/Github/Roper_EAD-ASEB_EPA_LISS_Disease_Surveillance/Lab_Data_RFTM\\All_RFTM_data.csv", row.names=FALSE)
```
...
write.csv(st_rftm_final, "C:/Users/kelly.roper/Documents/Github/Roper_EAD-ASEB_EPA_LISS_Disease_Surveillance/Lab_Data_RFTM\\Completeness_RFTM_intensity_data.csv", row.names=FALSE)
```
...
data_all_tissue <- list.files(path = "C:/Users/kelly.roper/Documents/Github/Roper_EAD-ASEB_EPA_LISS_Disease_Surveillance/Lab_Data_TissueProcessing/Files_by_Month",                           # Identify all CSV files
  pattern = "*.csv", full.names = TRUE) %>% 
  lapply(read_csv) %>%                              # Store all files in list
  bind_rows                                         # Combine data sets into one data set 
data_all_tissue      
