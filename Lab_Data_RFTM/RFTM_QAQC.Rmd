...
Last updated 11/09/2023 by M.Kachmar
Added language to distinguish prevalence, weighted prevalence, and intensity (population) calculations. I think we need to start using them correctly when talking about the data. 
Calculated Weighted prevalence, prevalence, and intensity (population)
Graphed weighted prevalence
