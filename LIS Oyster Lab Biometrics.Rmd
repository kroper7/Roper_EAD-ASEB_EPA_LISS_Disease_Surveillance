...
Updated 10/23/2023 by M. Kachmar
- All data up to date
- Added mean height plots to all individual sites
- Added bar graphs for body condition distribution 
  - BCS are currently categorical. Will need to change to numerical. i.e. 3 vs 3_good_minus
  - Q:We also in Apr & May using fat, medium, watery, for ASHC & FENC. How do we want to standardize this? 
...
ggplot(data=df_ASHC, aes(x= oyster_zone, y= condition_score, group = oyster_zone)) +
  geom_boxplot()+  #scale_fill_manual(values=c("forestgreen","orange", "purple"))+
  theme_bw() +  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank())+ 
  #theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))+
...
## Mean body condition per 'Zone'
ggplot(data=df_FENC, aes(x= oyster_zone, y= condition_score, group = oyster_zone)) +
  geom_boxplot()+  #scale_fill_manual(values=c("forestgreen","orange", "purple"))+
  theme_bw() +  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank())+ 
  #theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))+
  labs(title="Mean Body Condition index ", x ="Zone", y= " condition score (1-9)")
...
ggplot(data=df_FENC, aes(x= light_regime, y= condition_score, group = light_regime)) +
  geom_boxplot()+  #scale_fill_manual(values=c("forestgreen","orange", "purple"))+
  theme_bw() +  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank())+ 
  #theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))+
  labs(title="Mean Body Condition index ", x ="Zone", y= " condition score (1-9)")
