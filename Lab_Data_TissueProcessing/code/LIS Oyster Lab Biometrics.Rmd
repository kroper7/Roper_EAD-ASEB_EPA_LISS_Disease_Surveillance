...
##### USE THIS CODE TO MERGE DATA FILES - some of the files are not the same format (dates specifically), which was causing issues in merging. This code below should solve that problem. #####
