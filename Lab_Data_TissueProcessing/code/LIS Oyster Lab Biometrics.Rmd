...
pdf(paste0(path = "C:/Users/kyra.lenderman/documents/Github/EAD-ASEB_EPA_LISS_Disease_Surveillance/Lab_Data_TissueProcessing/output" ,"/FENC_BCS_proportion.pdf"), height = 7, width = 13)
...
df_FENC. <- df_FENC%>%filter(!row_number() %in% c(208))
