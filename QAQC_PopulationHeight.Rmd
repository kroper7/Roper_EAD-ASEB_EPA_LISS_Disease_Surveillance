...
ggplot(data=height_ASHC, aes(x= Height)) +
  ...
  labs(title="Ash Creek Height ", x ="Height (mm)")+ scale_x_continuous(limits= c(0,190), breaks = seq(0,190, by =10) )+
  ylim(0,50)+
...
df_density_sum_ASHC <- df_density_ASHC %>%
...
ggplot(data=height_GOLD, aes(x= Height)) +
  geom_histogram()+  #scale_fill_manual(values=c("forestgreen","orange", "purple"))+
  theme_bw() +  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank())+ 
  #theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))+
  labs(title="Goldstar Height ", x ="Height (mm)")+
  facet_wrap(~ Season, scales = "free", ncol = 1)
...
ggplot(data=df_quadrat_GOLD, aes(x= Survival_status, y = Count, fill = Survival_status)) +
  ...
  theme_bw() +  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank())+ 
  #theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))+
  labs(title="Goldstar Count ", x ="Survival status", y= "Density")+
  facet_wrap(~ Season, scales = "free")
...
ggplot(data=mean_total_oysters_GOLD, aes(x= Survival_status, y = Total_Density, fill = Survival_status)) +
  ...
  theme_bw() +  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank())+ 
  #theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))+
  labs(title="Goldstar Density ", x ="Survival status", y= "Density (# oyster / meter squared)")+
  facet_wrap(~ Season, scales = "free")
```
#LAUR
```{r}
