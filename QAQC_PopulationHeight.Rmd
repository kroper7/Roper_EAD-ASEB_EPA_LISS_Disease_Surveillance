...
length_live <- length_live %>% dplyr::rename(Height = Length_live)
length_live
...
length_box <- length_box %>% dplyr::rename(Height = Length_box)
...
length_gaper <- length_gaper %>% dplyr::rename(Height = Length_gaper)
