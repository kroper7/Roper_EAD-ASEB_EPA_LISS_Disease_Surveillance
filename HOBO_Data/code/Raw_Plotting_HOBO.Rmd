...
Last updated: 4/15/2024 by M. Kachmar 
-FENC & ASHC up to date & graphs produced
...
#### Fence Creek ####
```{r}
FENC_HOBO <- read_csv("HOBO_Data\\raw_data\\042024_FENC_HOBO.csv", col_names = TRUE)   
...
FENC_plot <- FENC_means %>%
    ...
    scale_x_datetime(date_labels = "%b/%Y", 
                     date_breaks = "1 month", 
                     limits = as.POSIXct(c('2023-06-01', '2024-05-01')))
FENC_plot
...
#### Ash Creek ####
```{r}
ASHC_HOBO <- read_csv("HOBO_Data\\raw_data\\052024_ASHC_HOBO.csv", col_names = TRUE)   
...
## Gold Star Beach
```{r}
GOLD_HOBO <- read_csv("HOBO_Data\\raw_data\\042024_GOLD_HOBO.csv", col_names = TRUE)   
