...
Last updated: 5/16/2024 by M. Kachmar 
...
#### Fence Creek ####
```{r}
FENC_HOBO <- read_csv("HOBO_Data\\raw_data\\052024_FENC_HOBO.csv", col_names = TRUE)   
...
## Gold Star Beach
```{r}
GOLD_HOBO <- read_csv("HOBO_Data\\raw_data\\052024_GOLD_HOBO.csv", col_names = TRUE)   
