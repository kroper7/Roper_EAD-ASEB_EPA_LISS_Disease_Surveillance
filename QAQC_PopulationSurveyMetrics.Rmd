...
charac_ASH <- read_excel("C:\\Users\\mariah.kachmar\\Documents\\Github\\EAD-ASEB_EPA_LISS_Disease_Surveillance\\Field_Data_Biological\\1023ASHC_Characteristics.xlsx",
                     sheet = 1, col_names = TRUE) 

shellsize_ASHC <- read_excel("C:\\Users\\mariah.kachmar\\Documents\\Github\\EAD-ASEB_EPA_LISS_Disease_Surveillance\\Field_Data_Biological\\1023ASHC_Length_Master.xlsx",
                     sheet = 1, col_names = TRUE) 


data_all_test <- merge(charac_ASH, shellsize_ASH, group_by())
