...
### NOTE: !!! changed to Mariah's path to make graphs for reports - if Sam needs to make edits make sure it is changed back. !!!
```{r}
path.p                   <- "C:/Users/mariah.kachmar/Documents/Github/EAD-ASEB_EPA_LISS_Disease_Surveillance/Sonde_Data" 
...
pdf(paste0(path_out,"/raw_plots/Report_plots/ASHC_pH.pdf"), height = 6, width = 11)
print(ASHC_pH_all, ncol = 2, widths = c(2, 1))
dev.off()
...
pdf(paste0(path_out,"/raw_plots/Report_plots/ASHC_Salinity.pdf"), height = 6, width = 11)
