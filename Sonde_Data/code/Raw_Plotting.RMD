...
- pdf() recieving errors that it "cannot open file". It appears it is connecting to the HOBO output file vs Sonde data outputs
    - (6/7/24): fixed error by replacing code with "path =" and adding output to the path.
...
pdf(paste0(path_out,"output/raw_plots/Temperature_JuneOct_2023.pdf"), height = 12, width = 15)
