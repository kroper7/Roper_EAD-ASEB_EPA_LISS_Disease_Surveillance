...
Last updated 6/6/2024 by M.Kachmar
- creating script for 2023 and 2024 to be able to pull years seperately. 
- pdf() recieving errors that it "cannot open file". It appears it is connecting to the HOBO output file vs Sonde data outputs
...
for(i in 1:nrow(vars)) {
  ...
  pdf(paste0(pathout,"/raw_plots/",gsub(" ", "_", vars[i,]),".pdf"), height = 12, width = 15)
  print(plot) 
  dev.off()
...
pdf(paste0(path_out,"/raw_plots/LISS_proposal_plots/CT_pH_2023.pdf"), height = 6, width = 11)
ggarrange(CT_pH_2023, CT_pH_callout_2023, ncol = 2, widths = c(2, 1))
dev.off()
...
pdf(paste0(path_out,"/raw_plots/LISS_proposal_plots/CT_pH_2024.pdf"), height = 6, width = 11)
...
pdf(paste0(path_out,"/raw_plots/LISS_proposal_plots/CT_Salinity_2023.pdf"), height = 6, width = 11)
...
pdf(paste0(path_out,"/raw_plots/LISS_proposal_plots/CT_Salinity_2024.pdf"), height = 6, width = 11)
...
pdf(paste0(path_out,"/raw_plots/LISS_proposal_plots/CT_Temperature_2023.pdf"), height = 6, width = 11)
...
pdf(paste0(path_out,"/raw_plots/LISS_proposal_plots/CT_Temperature_2024.pdf"), height = 6, width = 11)
...
CT_DO_callout_2023 <- CT_DO %>% na.omit() %>%
             ...
             ggplot(aes(x=`Date Time`, 
              ...
              theme(legend.position = "none", axis.title.y = element_blank())
CT_DO_callout_2023
pdf(paste0(path_out,"/raw_plots/LISS_proposal_plots/CT_DO_2023.pdf"), height = 6, width = 11)
...
CT_DO_callout_2024 <- CT_DO %>% na.omit() %>%
             ...
             ggplot(aes(x=`Date Time`, 
              ...
              theme(legend.position = "none", axis.title.y = element_blank())
CT_DO_callout_2024
pdf(paste0(path_out,"/raw_plots/LISS_proposal_plots/CT_DO_2024.pdf"), height = 6, width = 11)
...
pdf(paste0(path_out,"/raw_plots/Report_plots/ASHC_pH_2023.pdf"), height = 7, width = 14)
print(ASHC_pH_2023)
...
pdf(paste0(path_out,"/raw_plots/Report_plots/ASHC_pH_2024.pdf"), height = 7, width = 14)
print(ASHC_pH_2024)
#ggarrange(ASHC_pH_all,ASHC_pH_callout, ncol = 2, widths = c(2, 1))
dev.off()
...
pdf(paste0(path_out,"/raw_plots/Report_plots/ASHC_Salinity_2023.pdf"), height = 7, width = 14)
...
pdf(paste0(path_out,"/raw_plots/Report_plots/ASHC_Salinity_2024.pdf"), height = 7, width = 14)
...
pdf(paste0(path_out,"/raw_plots/Report_plots/ASHC_Temperature_2023.pdf"), height = 7, width = 14)
...
pdf(paste0(path_out,"/raw_plots/Report_plots/ASHC_Temperature_2024.pdf"), height = 7, width = 14)
...
pdf(paste0(path_out,"/raw_plots/Report_plots/ASHC_DO_2023.pdf"), height = 7, width = 14)
print(ASHC_DO_2023)
...
pdf(paste0(path_out,"/raw_plots/Report_plots/ASHC_DO_2024.pdf"), height = 7, width = 14)
print(ASHC_DO_2024)
#ggarrange(ASHC_DO_all, ASHC_DO_callout, ncol = 2, widths = c(2, 1))
dev.off()
...
pdf(paste0(path_out,"/raw_plots/Report_plots/ASHC_CHLA_2023.pdf"), height = 7, width = 14)
print(ASHC_CHLA_all)
...
pdf(paste0(path_out,"/raw_plots/Report_plots/ASHC_CHLA_2024.pdf"), height = 7, width = 14)
print(ASHC_CHLA_2024)
```
## Stopped splitting by year here
```{r}
